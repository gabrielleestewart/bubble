...
<details>
  ...
  <ol>
    <li>
      ...
      <ul>
        <li><a href="#built-with">Inspiration</a></li>
      </ul>
      <ul>
        <li><a href="#built-with">What it does</a></li>
      </ul>
      <ul>
        <li><a href="#built-with">How we built it</a></li>
      </ul>
      <ul>
        <li><a href="#built-with">Challenges we ran into</a></li>
      </ul>
      <ul>
        <li><a href="#built-with">Accomplishments that we're proud of</a></li>
      </ul>
      <ul>
        <li><a href="#built-with">What we learned</a></li>
      </ul>
      <ul>
        <li><a href="#built-with">What's next for Bubble</a></li>
      </ul>
      <ul>
